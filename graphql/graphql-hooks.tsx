 ...
 * });
 */
export function useAllCharactersQuery(
  ...
  return Apollo.useQuery<AllCharactersQuery, AllCharactersQueryVariables>(
    AllCharactersDocument,
    options
  );
}
export function useAllCharactersLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<AllCharactersQuery, AllCharactersQueryVariables>(
    AllCharactersDocument,
    options
  );
}
export type AllCharactersQueryHookResult = ReturnType<
  typeof useAllCharactersQuery
>;
export type AllCharactersLazyQueryHookResult = ReturnType<
  typeof useAllCharactersLazyQuery
>;
export type AllCharactersQueryResult = Apollo.QueryResult<
  AllCharactersQuery,
  AllCharactersQueryVariables
>;
...
export function useAllMoviesQuery(
  baseOptions?: Apollo.QueryHookOptions<AllMoviesQuery, AllMoviesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<AllMoviesQuery, AllMoviesQueryVariables>(
    AllMoviesDocument,
    options
  );
}
export function useAllMoviesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AllMoviesQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<AllMoviesQuery, AllMoviesQueryVariables>(
    AllMoviesDocument,
    options
  );
}
export type AllMoviesQueryHookResult = ReturnType<typeof useAllMoviesQuery>;
export type AllMoviesLazyQueryHookResult = ReturnType<
  typeof useAllMoviesLazyQuery
>;
export type AllMoviesQueryResult = Apollo.QueryResult<
  AllMoviesQuery,
  AllMoviesQueryVariables
>;
 ...
 * });
 */
export function useAllStarshipsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AllStarshipsQuery,
    AllStarshipsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<AllStarshipsQuery, AllStarshipsQueryVariables>(
    AllStarshipsDocument,
    options
  );
}
export function useAllStarshipsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AllStarshipsQuery,
    AllStarshipsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<AllStarshipsQuery, AllStarshipsQueryVariables>(
    AllStarshipsDocument,
    options
  );
}
export type AllStarshipsQueryHookResult = ReturnType<
  typeof useAllStarshipsQuery
>;
export type AllStarshipsLazyQueryHookResult = ReturnType<
  typeof useAllStarshipsLazyQuery
>;
export type AllStarshipsQueryResult = Apollo.QueryResult<
  AllStarshipsQuery,
  AllStarshipsQueryVariables
>;

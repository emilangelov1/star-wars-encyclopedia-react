...
export type SinglePersonQueryVariables = Exact<{
  personId?: InputMaybe<Scalars["ID"]>;
}>;

export type SinglePersonQuery = {
  __typename?: "Root";
  person?: {
    __typename?: "Person";
    name?: string | null;
...
export const SinglePersonDocument = gql`
  query singlePerson($personId: ID) {
    person(id: $personId) {
      name
      skinColor
      gender
...
/**
 * __useSinglePersonQuery__
 *
 * To run a query within a React component, call `useSinglePersonQuery` and pass it any options that fit your needs.
 * When your component renders, `useSinglePersonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSinglePersonQuery({
 *   variables: {
 *      personId: // value for 'personId'
 *   },
 * });
 */
export function useSinglePersonQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SinglePersonQuery,
    SinglePersonQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SinglePersonQuery, SinglePersonQueryVariables>(
    SinglePersonDocument,
    options
  );
}
export function useSinglePersonLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SinglePersonQuery, SinglePersonQueryVariables>(
    SinglePersonDocument,
    options
  );
}
export type SinglePersonQueryHookResult = ReturnType<
  typeof useSinglePersonQuery
>;
export type SinglePersonLazyQueryHookResult = ReturnType<
  typeof useSinglePersonLazyQuery
>;
export type SinglePersonQueryResult = Apollo.QueryResult<
  SinglePersonQuery,
  SinglePersonQueryVariables
>;
